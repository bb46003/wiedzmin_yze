  ...
  async rollInitiative(
    ...
    if ("rollMode" in messageOptions) {
      foundry.utils.logCompatibilityWarning(
        "The rollMode option of Combat#rollInitiative messageOptions is" +
          " deprecated in favor of the `messageMode` option, a string key of CONFIG.ChatMessage.modes",
        { since: 14, until: 16 },
      );
      messageMode = foundry.dice.Roll._mapLegacyRollMode(
      ...
      const messageData = foundry.utils.mergeObject(
        {
          ...
          flavor:
            "Rzut na inicjatywę przez " +
            foundry.utils.escapeHTML(combatant.name),
